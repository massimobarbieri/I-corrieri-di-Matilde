...
\begin{DndReadAloud}
Quelli che vi sembravano un mucchio di vestiti, mano a mano che vi avvicinate, assumono sempre di più la forma umanoide. Ora che siete più vicini capite che state osservando una creatua umanoide riversa a terra. Le braccia sono sotto al corpo in posizione prona e il volto è nascosto nella neve. Svariate impronte conducono nel bosco sulla destra.
\end{DndReadAloud}
