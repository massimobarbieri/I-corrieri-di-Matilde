...
\includegraphics[width=7.5cm]{img/tobaldo-malatesta.png}
    \caption{\textsf{Tobaldo Malatesta, servitore di alto rango di Matilde di Canossa.}}
    \label{fig:tobaldo}
\end{figure}
...
\includegraphics[width=7.5cm]{img/filippo-pocaterra.png}
    \caption{\textsf{Filippo Pocaterra, oste e proprietario della locanda Il cane zoppo a San Polo d'Enza.}}
    \label{fig:oste}
\end{figure}
