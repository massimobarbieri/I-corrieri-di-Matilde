...
Le seguenti descrizioni fanno riferimento alla figura \ref{rossena1}

\DndSubArea{Sala del trono} %a
La sala del trono arricchita alle pareti con arazzi e dipinti. La sala è spoglia, probabilmente destinata a ricevere numerose persone.

\DndSubArea{Ingresso} %b
Sala d'attesa per le persone che hanno necessità di essere ricevute dal regnante. Nella stanza è presente un tappeto con un tavolo, una libreria che contiene volumi inerenti battaglie e discendenze nobiliari dei Canossa.

\DndSubArea{Dispensa}
Dispensa della cucina (Area 1d). In questa dispensa sono presenti barili di vino e un piccolo barile di aceto. Nelle scaffalature cassette di verdure, formaggi e salumi stagionati.

\DndSubArea{Cucina}
In questa stanza sono presenti 3 cuochi impegnati a preparare il cibo per il pasto successivo. Ad esclusione della notte è sempre presente qualcuno che sta cucinando.

\DndSubArea{Sala}
Stanza di passaggio fra la cucina e il salone da pranzo.

\DndSubArea{Sala pranzo}
...
La camera di Goffredo ha un letto in legno, davanti ad esso una pelle di orso funge da tappeto. Un armadio è in realtà un passaggio segreto che dall'interno permette di passare alla stanza 1c. Nella stessa stanza è presente una latrina che scarica direttamente fuori, una sedia e un'armatura in metallo.
